          ...
          {[
            {
              title: "Интересы",
              icon: Users,
              items: ["Fashion → одежда, обувь", "Техника → бытовая техника и электроника", "Beauty → уход, парфюм и макияж", "Дом → кухня, посуда", "Дети / семья → игрушки, питание и одежда", "Продукты → питание"]
            },
            {
              title: "Сезонность",
              icon: Calendar,
